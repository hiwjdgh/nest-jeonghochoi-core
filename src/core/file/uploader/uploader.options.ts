...
/** @deprecated use UploaderDefinition */
export type UploderDefinition = UploaderDefinition;
/** @deprecated use UploaderOptions */
export type UploderOptions = UploaderOptions;
